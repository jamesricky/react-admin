...
const Picker: React.FC<TimePickerProps & FieldRenderProps<string, HTMLInputElement>> = ({
    ...
    const [showInvalidError, setShowInvalidError] = React.useState<boolean>(false);
    ...
    const onInputFocus = () => {
        console.log("aaaaaaa", "onInputFocus");
    ...
    console.log("aaaaaaa", "RENDER", { showInvalidError });
    ...
    return (
        <>
            ...
            {showInvalidError && (
                <FinalFormField name={input.name} validate={() => invalidValueText}>
                    {() => null}
                </FinalFormField>
            )}
        </>
